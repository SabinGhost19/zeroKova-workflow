...
type InventoryServiceClient interface {
	...
	ReserveStock(ctx context.Context, in *ReserveStockRequest, opts ...grpc.CallOption) (*common.StatusResponse, error)
	// Release reserved stock
	ReleaseStock(ctx context.Context, in *ReleaseStockRequest, opts ...grpc.CallOption) (*common.StatusResponse, error)
	// List all products
...
func (c *inventoryServiceClient) ReserveStock(ctx context.Context, in *ReserveStockRequest, opts ...grpc.CallOption) (*common.StatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *inventoryServiceClient) ReleaseStock(ctx context.Context, in *ReleaseStockRequest, opts ...grpc.CallOption) (*common.StatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(common.StatusResponse)
...
type InventoryServiceServer interface {
	...
	// Reserve stock for an order
	ReserveStock(context.Context, *ReserveStockRequest) (*common.StatusResponse, error)
	// Release reserved stock
	ReleaseStock(context.Context, *ReleaseStockRequest) (*common.StatusResponse, error)
	// List all products
...
func (UnimplementedInventoryServiceServer) ReserveStock(context.Context, *ReserveStockRequest) (*common.StatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReserveStock not implemented")
}
func (UnimplementedInventoryServiceServer) ReleaseStock(context.Context, *ReleaseStockRequest) (*common.StatusResponse, error) {
