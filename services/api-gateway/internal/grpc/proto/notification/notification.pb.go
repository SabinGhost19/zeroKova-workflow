...
type StockAlertRequest struct {
	...
	AlertType       string                 `protobuf:"bytes,4,opt,name=alert_type,json=alertType,proto3" json:"alert_type,omitempty"` // LOW_STOCK, OUT_OF_STOCK, RESTOCKED
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_notification_proto_rawDesc = "" +
	"\n" +
	"\x12notification.proto\x12\fnotification\x1a\fcommon.proto\"\x95\x01\n" +
	...
	"\x10GetNotifications\x12%.notification.GetNotificationsRequest\x1a#.notification.NotificationsResponseBt\n" +
	"\x16com.testworkflow.protoZEgithub.com/test-workflow/api-gateway/internal/grpc/proto/notification\xaa\x02\x12TestWorkflow.Protob\x06proto3"
